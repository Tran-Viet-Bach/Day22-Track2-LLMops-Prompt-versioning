...
class PIIDetector(Validator):
    ...
    def validate(self, value: str, metadata: dict):
        """
        Tìm PII trong value; nếu phát hiện, redact bằng on_fail=FIX.
...
class JSONFormatter(Validator):
    ...
    def _repair(text: str) -> str:
        ...
        # Chỉ sửa nháy đơn đóng vai trò key/string JSON, không thay apostrophe tùy tiện.
    ...
    def validate(self, value: str, metadata: dict):
        ...
        try:
            ...
            fallback = json.dumps(
                {"error": "Khong the phan tich JSON", "raw": value[:200]},
                ensure_ascii=False,
            )
            return FailResult(
